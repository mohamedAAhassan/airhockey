...
OUTPUT_PATH=dist/Debug_Linux/${PLATFORM}/airhockey
...
# Generate tar file
cd "${TOP}"
rm -f dist/Debug_Linux/${PLATFORM}/package/airhockey.tar
cd ${TMPDIR}
tar -vcf ../../../../dist/Debug_Linux/${PLATFORM}/package/airhockey.tar *
checkReturnCode
