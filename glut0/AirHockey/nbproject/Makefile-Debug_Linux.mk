...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Debug_Linux.mk dist/Debug_Linux/${PLATFORM}/airhockey

dist/Debug_Linux/${PLATFORM}/airhockey: ${OBJECTFILES}
	${MKDIR} -p dist/Debug_Linux/${PLATFORM}
	${LINK.cc} -o dist/Debug_Linux/${PLATFORM}/airhockey ${OBJECTFILES} ${LDLIBSOPTIONS} 

${OBJECTDIR}/src/Point2.o: src/Point2.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Point2.o src/Point2.cpp
...
${OBJECTDIR}/src/Pak.o: src/Pak.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Pak.o src/Pak.cpp
...
${OBJECTDIR}/src/polyscript/parser.o: src/polyscript/parser.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/polyscript
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/polyscript/parser.o src/polyscript/parser.cpp

${OBJECTDIR}/src/Kij.o: src/Kij.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Kij.o src/Kij.cpp

${OBJECTDIR}/src/graphics.o: src/graphics.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/graphics.o src/graphics.cpp
...
.clean-conf:
	...
	${RM} dist/Debug_Linux/${PLATFORM}/airhockey
